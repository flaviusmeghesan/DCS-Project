...
public class BucharestIntersection2 {
	public static void main(String[] args) {
		...
		DataString P_SINCAINORD_TL = new DataString(); //p7.Printable = false;
		P_SINCAINORD_TL.SetName("P_SINCAINORD_TL");
		P_SINCAINORD_TL.SetValue("red"); // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		pn.PlaceList.add(P_SINCAINORD_TL);
		...
		DataCarQueue P_X_CANTREMIR = new DataCarQueue();
		P_X_CANTREMIR.Value.Size = 3;
		P_X_CANTREMIR.SetName("P_X_CANTREMIR");
		pn.PlaceList.add(P_X_CANTREMIR);

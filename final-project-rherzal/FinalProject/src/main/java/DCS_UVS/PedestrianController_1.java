...
public class PedestrianController_1 {

    public static void main (String []args) {
        PetriNet pn  = new PetriNet();
        pn.PetriNetName = "PED_CROSSING_CONTROLLER_2";
        pn.SetName("PED_CROSSING_CONTROLLER_2");
        pn.NetworkPort = 1084;
        ...
        DataString USREQ_CANTEMIR_2 = new DataString();
        USREQ_CANTEMIR_2.SetName("USREQ_CANTEMIR_2");
        pn.PlaceList.add(USREQ_CANTEMIR_2);
...
//        WAIT.SetValue("red");
        ...
        DataTransfer P_CANTEMIR_TL_2 = new DataTransfer();
        P_CANTEMIR_TL_2.SetName("P_CANTEMIR_TL_2");
        P_CANTEMIR_TL_2.Value = new TransferOperation("localhost", "1080" , "P_CANTEMIR_TL_21");
        pn.PlaceList.add(P_CANTEMIR_TL_2);

        DataTransfer P_CANTEMIR_PTL_2 = new DataTransfer();
        P_CANTEMIR_PTL_2.SetName("P_CANTEMIR_PTL_2");
        P_CANTEMIR_PTL_2.Value = new TransferOperation("localhost", "1080" , "P_CANTEMIR_PTL_21");
        ...
        T_INIGrd.Activations.add(new Activation(T_INI,"green", TransitionOperation.SendOverNetwork,"P_CANTEMIR_TL_2"));
        T_INIGrd.Activations.add(new Activation(T_INI,"red", TransitionOperation.SendOverNetwork,"P_CANTEMIR_PTL_2"));
        T_INIGrd.Activations.add(new Activation(T_INI, "", TransitionOperation.MakeNull, "P_INI"));
        ...
        T1.SetName("T1");
        T1.InputPlaceName.add("USREQ_CANTEMIR_2");
        T1.InputPlaceName.add("WAIT");

        Condition T1C1 = new Condition(T1, "USREQ_CANTEMIR_2", TransitionCondition.NotNull);
        ...
        T1Grd.Activations.add(new Activation(T1,"yellow", TransitionOperation.SendOverNetwork,"P_CANTEMIR_TL_2"));
        ...
        T2Grd.Activations.add(new Activation(T2,"red", TransitionOperation.SendOverNetwork,"P_CANTEMIR_TL_2"));
        T2Grd.Activations.add(new Activation(T2,"green", TransitionOperation.SendOverNetwork,"P_CANTEMIR_PTL_2"));
        ...
        T3Grd.Activations.add(new Activation(T3,"yellow", TransitionOperation.SendOverNetwork,"P_CANTEMIR_PTL_2"));
        ...
        T4Grd.Activations.add(new Activation(T4,"green", TransitionOperation.SendOverNetwork,"P_CANTEMIR_TL_2"));
        T4Grd.Activations.add(new Activation(T4,"red", TransitionOperation.SendOverNetwork,"P_CANTEMIR_PTL_2"));

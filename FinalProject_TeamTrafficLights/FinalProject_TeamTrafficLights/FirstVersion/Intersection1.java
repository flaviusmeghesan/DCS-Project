...
public class Intersection1 {
    ...
    public static void main(String[] args) {
        ...
        OPReq1.Value = new TransferOperation("localhost", "1083" , "UserReq1");
        ...
        pn.PlaceList.add(UserReq2);

        DataString P_PTL2 = new DataString();
        P_PTL2.SetName("P_PTL2");
        pn.PlaceList.add(P_PTL2);

        DataTransfer OPReq2 = new DataTransfer();
        OPReq2.SetName("OPReq2");
        OPReq2.Value = new TransferOperation("localhost", "1083" , "UserReq2");
        pn.PlaceList.add(OPReq2);
        ...
        DataString P_PTL3 = new DataString();
        P_PTL3.SetName("P_PTL3");
        pn.PlaceList.add(P_PTL3);

        DataTransfer OPReq3 = new DataTransfer();
        OPReq3.SetName("OPReq3");
        OPReq3.Value = new TransferOperation("localhost", "1083" , "UserReq3");
        pn.PlaceList.add(OPReq3);
        ...
        OPReq4.Value = new TransferOperation("localhost", "1083" , "UserReq4");
        ...
        // ToDo: need to make transition t22 for it and add in the Petri Net
        ...
        // T_TL1b  ----------------------------------------------------------------------------------------------------------------------------------------------------------
        PetriTransition t_TL1b = new PetriTransition(pn);
        t_TL1b.TransitionName = "T_TL1b";
        t_TL1b.InputPlaceName.add("P_x1b");
        t_TL1b.InputPlaceName.add("P_TL1");
        t_TL1b.InputPlaceName.add("P_PTL1");
        t_TL1b.InputPlaceName.add("UserReq1");

        Condition T_TL1bCt1 = new Condition(t_TL1b, "P_TL1", TransitionCondition.Equal, "green");
        Condition T_TL1bCt2 = new Condition(t_TL1b, "P_x1b", TransitionCondition.HaveCar);
        Condition T_TL1bCt3 = new Condition(t_TL1b, "P_PTL1", TransitionCondition.Equal,"P_PTL1");
        Condition T_TL1bCt4 = new Condition(t_TL1b, "UserReq1", TransitionCondition.NotNull);
        //Condition T_TL1bCt5 = new Condition(t_TL1b, "P_x1b", TransitionCondition.HavePriorityCar);

        T_TL1bCt1.SetNextCondition(LogicConnector.AND, T_TL1bCt2);
        T_TL1bCt1.SetNextCondition(LogicConnector.AND, T_TL1bCt3);
        T_TL1bCt1.SetNextCondition(LogicConnector.AND, T_TL1bCt4);
       // T_TL1bCt1.SetNextCondition(LogicConnector.OR, T_TL1bCt5);

        GuardMapping grdT_TL1b = new GuardMapping();
        grdT_TL1b.condition = T_TL1bCt1;
        grdT_TL1b.Activations.add(new Activation(t_TL1b, "P_x1b", TransitionOperation.PopElementWithoutTarget, "P_b1b")); //Street "sends the car"
        grdT_TL1b.Activations.add(new Activation(t_TL1b, "P_TL1", TransitionOperation.Move, "P_TL1"));
        grdT_TL1b.Activations.add(new Activation(t_TL1b, "P_PTL1", TransitionOperation.Move, "P_PTL1"));
        grdT_TL1b.Activations.add(new Activation(t_TL1b, "UserReq1", TransitionOperation.SendOverNetwork, "OPReq1"));

        t_TL1b.GuardMappingList.add(grdT_TL1b);

        t_TL1b.Delay = 0;
        pn.Transitions.add(t_TL1b);
        ...
        Condition T_1esCt1 = new Condition(t_1es, "P_station1", TransitionCondition.HaveBus);
        ...
        grdT_ex1.Activations.add(new Activation(t_ex1, "P12", TransitionOperation.PopElementWithoutTargetToQueue, "P_ex1"));
        ...
        PetriTransition t_TL2 = new PetriTransition(pn);
        t_TL2.TransitionName = "T_TL2";
        t_TL2.InputPlaceName.add("P_x2");
        t_TL2.InputPlaceName.add("P_TL2");
        t_TL2.InputPlaceName.add("P_PTL2");
        t_TL2.InputPlaceName.add("UserReq2");

        Condition T_TL2Ct1 = new Condition(t_TL2, "P_TL2", TransitionCondition.Equal, "green");
        Condition T_TL2Ct2 = new Condition(t_TL2, "P_x2", TransitionCondition.HaveCar);
        Condition T_TL2Ct3 = new Condition(t_TL2, "P_PTL2", TransitionCondition.Equal,"P_PTL2");
        Condition T_TL2Ct4 = new Condition(t_TL2, "UserReq2", TransitionCondition.NotNull);

        T_TL2Ct1.SetNextCondition(LogicConnector.AND, T_TL2Ct2);
        T_TL2Ct1.SetNextCondition(LogicConnector.AND, T_TL2Ct3);
        T_TL2Ct1.SetNextCondition(LogicConnector.AND, T_TL2Ct4);

        GuardMapping grdT_TL2 = new GuardMapping();
        grdT_TL2.condition = T_TL2Ct1;
        grdT_TL2.Activations.add(new Activation(t_TL2, "P_x2", TransitionOperation.PopElementWithoutTarget, "P_b2")); //Street "sends the car"
        grdT_TL2.Activations.add(new Activation(t_TL2, "P_TL2", TransitionOperation.Move, "P_TL2"));
        grdT_TL2.Activations.add(new Activation(t_TL2, "P_PTL2", TransitionOperation.Move, "P_PTL2"));
        grdT_TL2.Activations.add(new Activation(t_TL2, "UserReq2", TransitionOperation.SendOverNetwork, "OPReq2"));

        t_TL2.GuardMappingList.add(grdT_TL2);

        t_TL2.Delay = 0;
        pn.Transitions.add(t_TL2);
        ...
        t_park.InputPlaceName.add("P_a3");

        Condition T_parkCt1 = new Condition(t_park, "P_a3", TransitionCondition.NotNull);
        ...
        grdT_parkCt1.Activations.add(new Activation(t_park, "P_a3", TransitionOperation.AddElement, "P_park"));
        ...
        PetriTransition t_TL3 = new PetriTransition(pn);
        t_TL3.TransitionName = "T_TL3";
        t_TL3.InputPlaceName.add("P_x3");
        t_TL3.InputPlaceName.add("P_TL3");
        t_TL3.InputPlaceName.add("P_PTL3");
        t_TL3.InputPlaceName.add("UserReq3");

        Condition T_TL3Ct1 = new Condition(t_TL3, "P_TL3", TransitionCondition.Equal, "green");
        Condition T_TL3Ct2 = new Condition(t_TL3, "P_x3", TransitionCondition.HaveCar);
        Condition T_TL3Ct3 = new Condition(t_TL3, "P_PTL3", TransitionCondition.Equal,"P_PTL3");
        Condition T_TL3Ct4 = new Condition(t_TL3, "UserReq3", TransitionCondition.NotNull);

        T_TL3Ct1.SetNextCondition(LogicConnector.AND, T_TL3Ct2);
        T_TL3Ct1.SetNextCondition(LogicConnector.AND, T_TL3Ct3);
        T_TL3Ct1.SetNextCondition(LogicConnector.AND, T_TL3Ct4);

        GuardMapping grdT_TL3 = new GuardMapping();
        grdT_TL3.condition = T_TL3Ct1;
        grdT_TL3.Activations.add(new Activation(t_TL3, "P_x3", TransitionOperation.PopElementWithoutTarget, "P_b3")); //Street "sends the car"
        grdT_TL3.Activations.add(new Activation(t_TL3, "P_TL3", TransitionOperation.Move, "P_TL3"));
        grdT_TL3.Activations.add(new Activation(t_TL3, "P_PTL3", TransitionOperation.Move, "P_PTL3"));
        grdT_TL3.Activations.add(new Activation(t_TL3, "UserReq3", TransitionOperation.SendOverNetwork, "OPReq3"));

        t_TL3.GuardMappingList.add(grdT_TL3);

        t_TL3.Delay = 0;
        pn.Transitions.add(t_TL3);
        ...
        PetriTransition t_TL4 = new PetriTransition(pn);
        t_TL4.TransitionName = "T_TL4";
        t_TL4.InputPlaceName.add("P_x4b");
        t_TL4.InputPlaceName.add("P_TL4");
        t_TL4.InputPlaceName.add("UserReq4");
        t_TL4.InputPlaceName.add("P_PTL4");

        Condition T_TL4Ct1 = new Condition(t_TL4, "P_TL4", TransitionCondition.Equal, "green");
        Condition T_TL4Ct2 = new Condition(t_TL4, "P_x4b", TransitionCondition.HaveCar);
        Condition T_TL4Ct3 = new Condition(t_TL4, "P_PTL4", TransitionCondition.Equal,"P_PTL4");
        Condition T_TL4Ct4 = new Condition(t_TL4, "UserReq4", TransitionCondition.NotNull);
        T_TL4Ct1.SetNextCondition(LogicConnector.AND, T_TL4Ct2);
        T_TL4Ct1.SetNextCondition(LogicConnector.AND, T_TL4Ct3);
        T_TL4Ct1.SetNextCondition(LogicConnector.AND, T_TL4Ct4);

        GuardMapping grdT_TL4 = new GuardMapping();
        grdT_TL4.condition = T_TL4Ct1;
        grdT_TL4.Activations.add(new Activation(t_TL4, "P_x4b", TransitionOperation.PopElementWithoutTarget, "P_b4b")); //Street "sends the car"
        grdT_TL4.Activations.add(new Activation(t_TL4, "P_TL4", TransitionOperation.Move, "P_TL4"));
        grdT_TL4.Activations.add(new Activation(t_TL4, "P_PTL4", TransitionOperation.Move, "P_PTL4"));
        grdT_TL4.Activations.add(new Activation(t_TL4, "UserReq4", TransitionOperation.SendOverNetwork, "OPReq4"));
        t_TL4.GuardMappingList.add(grdT_TL4);

        t_TL4.Delay = 0;
        pn.Transitions.add(t_TL4);
        ...
        grdT_T42.Activations.add(new Activation(t42, "P_o4be", TransitionOperation.AddElement, "P42"));

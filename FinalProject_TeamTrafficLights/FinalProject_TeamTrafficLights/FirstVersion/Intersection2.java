...
public class Intersection2 {
    public static void main(String[] args) {
        ...
        pn.PlaceList.add(UserReq5);

        DataTransfer OPReq5 = new DataTransfer();
        OPReq5.SetName("OPReq5");
        OPReq5.Value = new TransferOperation("localhost", "1083" , "UserReq5");
        pn.PlaceList.add(OPReq5);
        ...
        DataCarQueue p85 = new DataCarQueue();
        p85.SetName("P_b7");
        p85.Value.Size = 4;
        pn.PlaceList.add(p85);

        DataCar p68 = new DataCar();
        p68.SetName("P_en7");
        pn.PlaceList.add(p68);

        DataString p95 = new DataString();
        p95.SetName("P_TL7");
        pn.PlaceList.add(p95);

        DataString P_PTL7 = new DataString();
        P_PTL7.SetName("P_PTL7");
        pn.PlaceList.add(P_PTL7);

        DataString UserReq7 = new DataString();
        UserReq7.SetName("UserReq7");
        pn.PlaceList.add(UserReq7);

        DataTransfer OPReq7 = new DataTransfer();
        OPReq7.SetName("OPReq7");
        OPReq7.Value = new TransferOperation("localhost", "1083" , "UserReq7");
        pn.PlaceList.add(OPReq7);
        ...
        // T_TL5----------------------------------------------------------------------------------------------------------
        PetriTransition t_TL5 = new PetriTransition(pn);
        t_TL5.TransitionName = "T_TL5";
        t_TL5.InputPlaceName.add("P_x5");
        t_TL5.InputPlaceName.add("P_TL5");
        t_TL5.InputPlaceName.add("UserReq5");
        t_TL5.InputPlaceName.add("P_PTL5");

        Condition T_TL5Ct1 = new Condition(t_TL5, "P_TL5", TransitionCondition.Equal, "green");
        Condition T_TL5Ct2 = new Condition(t_TL5, "P_x5", TransitionCondition.HaveCar);
        Condition T_TL5Ct3 = new Condition(t_TL5, "P_PTL5", TransitionCondition.Equal,"P_PTL5");
        Condition T_TL5Ct4 = new Condition(t_TL5, "UserReq5", TransitionCondition.NotNull);
        T_TL5Ct1.SetNextCondition(LogicConnector.AND, T_TL5Ct2);
        T_TL5Ct1.SetNextCondition(LogicConnector.AND, T_TL5Ct3);
        T_TL5Ct1.SetNextCondition(LogicConnector.AND, T_TL5Ct4);

        GuardMapping grdT_TL5 = new GuardMapping();
        grdT_TL5.condition = T_TL5Ct1;
        grdT_TL5.Activations.add(new Activation(t_TL5, "P_x5", TransitionOperation.PopElementWithoutTarget, "P_b5")); //Street "sends the car"
        grdT_TL5.Activations.add(new Activation(t_TL5, "P_TL5", TransitionOperation.Move, "P_TL5"));
        grdT_TL5.Activations.add(new Activation(t_TL5, "P_PTL5", TransitionOperation.Move, "P_PTL5"));
        grdT_TL5.Activations.add(new Activation(t_TL5, "UserReq5", TransitionOperation.SendOverNetwork, "OPReq5"));
        t_TL5.GuardMappingList.add(grdT_TL5);

        t_TL5.Delay = 0;
        pn.Transitions.add(t_TL5);
        ...
        t_o7.InputPlaceName.add("P_b7");

        Condition T_o7Ct1 = new Condition(t_o7, "P_Is2", TransitionCondition.HaveCarForMe);
        Condition T_o7Ct2 = new Condition(t_o7, "P_b7", TransitionCondition.CanAddCars);

        T_o7Ct1.SetNextCondition(LogicConnector.AND, T_o7Ct2);

        GuardMapping grdT_o7 = new GuardMapping();
        grdT_o7.condition = T_o7Ct1;
        grdT_o7.Activations.add(new Activation(t_o7, "P_Is2", TransitionOperation.PopElementWithTargetToQueue, "P_b7"));
        ...
        PetriTransition t_TL7 = new PetriTransition(pn);
        t_TL7.TransitionName = "T_TL7";
        t_TL7.InputPlaceName.add("P_b7");
        t_TL7.InputPlaceName.add("P_TL7");
        t_TL7.InputPlaceName.add("UserReq7");
        t_TL7.InputPlaceName.add("P_PTL7");

        Condition T_TL7Ct1 = new Condition(t_TL7, "P_TL7", TransitionCondition.Equal, "green");
        Condition T_TL7Ct2 = new Condition(t_TL7, "P_b7", TransitionCondition.HaveCar);
        Condition T_TL7Ct3 = new Condition(t_TL7, "P_PTL7", TransitionCondition.Equal,"P_PTL7");
        Condition T_TL7Ct4 = new Condition(t_TL7, "UserReq7", TransitionCondition.NotNull);
        T_TL7Ct1.SetNextCondition(LogicConnector.AND, T_TL7Ct2);
        T_TL7Ct1.SetNextCondition(LogicConnector.AND, T_TL7Ct3);
        T_TL7Ct1.SetNextCondition(LogicConnector.AND, T_TL7Ct4);

        GuardMapping grdT_TL7 = new GuardMapping();
        grdT_TL7.condition = T_TL7Ct1;
        grdT_TL7.Activations.add(new Activation(t_TL7, "P_b7", TransitionOperation.PopElementWithoutTarget, "P_o7"));
        grdT_TL7.Activations.add(new Activation(t_TL7, "P_TL7", TransitionOperation.Move, "P_TL8"));
        grdT_TL7.Activations.add(new Activation(t_TL7, "P_PTL7", TransitionOperation.Move, "P_PTL8"));
        grdT_TL7.Activations.add(new Activation(t_TL7, "UserReq7", TransitionOperation.SendOverNetwork, "OPReq7"));
        t_TL7.GuardMappingList.add(grdT_TL7);

        t_TL7.Delay = 0;
        pn.Transitions.add(t_TL7);
        //T_o7e------------------------------------------------------------------------------------------------------------------
        ...
        // T_TL8b ------------------------------------------------
        PetriTransition t_TL8b = new PetriTransition(pn);
        t_TL8b.TransitionName = "T_TL8b";
        t_TL8b.InputPlaceName.add("P_x8b");
        t_TL8b.InputPlaceName.add("P_TL8");
        t_TL8b.InputPlaceName.add("UserReq8");
        t_TL8b.InputPlaceName.add("P_PTL8");

        Condition T_TL8bCt1 = new Condition(t_TL8b, "P_TL8", TransitionCondition.Equal, "green");
        Condition T_TL8bCt2 = new Condition(t_TL8b, "P_x8b", TransitionCondition.HaveCar);
        Condition T_TL8bCt3 = new Condition(t_TL8b, "P_PTL8", TransitionCondition.Equal,"P_PTL8");
        Condition T_TL8bCt4 = new Condition(t_TL8b, "UserReq5", TransitionCondition.NotNull);
        T_TL8bCt1.SetNextCondition(LogicConnector.AND, T_TL8bCt2);
        T_TL8bCt1.SetNextCondition(LogicConnector.AND, T_TL8bCt3);
        T_TL8bCt1.SetNextCondition(LogicConnector.AND, T_TL8bCt4);

        GuardMapping grdT_TL8b = new GuardMapping();
        grdT_TL8b.condition = T_TL8bCt1;
        grdT_TL8b.Activations.add(new Activation(t_TL8b, "P_x8b", TransitionOperation.PopElementWithoutTarget, "P_b8b"));
        grdT_TL8b.Activations.add(new Activation(t_TL8b, "P_TL8", TransitionOperation.Move, "P_TL8"));
        grdT_TL8b.Activations.add(new Activation(t_TL8b, "P_PTL8", TransitionOperation.Move, "P_PTL8"));
        grdT_TL8b.Activations.add(new Activation(t_TL8b, "UserReq8", TransitionOperation.SendOverNetwork, "OPReq8"));
        t_TL8b.GuardMappingList.add(grdT_TL8b);

        t_TL8b.Delay = 0;
        pn.Transitions.add(t_TL8b);
        ...
        grdT_o8e.Activations.add(new Activation(t_o8e, "P_o8", TransitionOperation.PopElementWithoutTarget, "P_o8e"));

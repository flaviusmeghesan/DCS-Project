...
public class ControllerPedestrians2 {

    public static void main (String []args) {
        PetriNet pn = new PetriNet();
        pn.PetriNetName = "ControllerPedestrians2";
        pn.SetName("ControllerPedestrians2");
        pn.NetworkPort = 1085;
        ...
        p6.SetName("P_TL8");
        p6.Value = new TransferOperation("localhost", "1084" , "P_TL8");
        pn.PlaceList.add(p6);

        DataTransfer p7 = new DataTransfer();
        p7.SetName("P_PTL8");
        p7.Value = new TransferOperation("localhost", "1084" , "P_PTL8");
        pn.PlaceList.add(p7);
        ...
        grdiniT.Activations.add(new Activation(iniT, "green", TransitionOperation.SendOverNetwork, "P_TL8"));
        ...
        t1.InputPlaceName.add("UserReq8");

        Condition T1Ct1 = new Condition(t1, "wait", TransitionCondition.NotNull);
        Condition T1Ct2 = new Condition(t1, "UserReq8", TransitionCondition.NotNull);
        T1Ct1.SetNextCondition(LogicConnector.AND, T1Ct2);

        GuardMapping grdT1 = new GuardMapping();
        grdT1.condition= T1Ct1;
        grdT1.Activations.add(new Activation(t1, "wait", TransitionOperation.Move, "yr"));
        grdT1.Activations.add(new Activation(t1, "yellow", TransitionOperation.SendOverNetwork, "P_TL8"));
        ...
        grdT2.Activations.add(new Activation(t2, "red", TransitionOperation.SendOverNetwork, "P_TL8"));
        grdT2.Activations.add(new Activation(t2, "green", TransitionOperation.SendOverNetwork, "P_PTL8"));
        ...
        grdT3.Activations.add(new Activation(t3, "yellow", TransitionOperation.SendOverNetwork, "P_PTL8"));
        ...
        grdT4.Activations.add(new Activation(t4, "red", TransitionOperation.SendOverNetwork, "P_PTL8"));
        grdT4.Activations.add(new Activation(t4, "green", TransitionOperation.SendOverNetwork, "P_TL8"));
        ...
        System.out.println("ControllerPedestrians2 started \n ------------------------------");
        pn.Delay = 2000;
        // pn.Start();

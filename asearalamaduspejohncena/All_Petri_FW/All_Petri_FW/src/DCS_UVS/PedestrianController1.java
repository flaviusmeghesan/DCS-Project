...
public class PedestrianController1 {
    public static void main (String []args) {
        ...
        DataTransfer P_PED_TL = new DataTransfer();
        P_PED_TL.SetName("P_PED_TL");
        P_PED_TL.Value = new TransferOperation("localhost", "1080" , "P_PED_TL");
        ...
        T_INIGrd.Activations.add(new Activation(T_INI,"green", TransitionOperation.SendOverNetwork,"P_PED_TL"));
        T_INIGrd.Activations.add(new Activation(T_INI,"red", TransitionOperation.SendOverNetwork,"P_PTL"));
        ...
        Condition T1C1 = new Condition(T1, "USERREQ_20_0", TransitionCondition.NotNull);
        ...
        T1Grd.Activations.add(new Activation(T1,"yellow", TransitionOperation.SendOverNetwork,"P_PED_TL"));
        ...
        T2Grd.Activations.add(new Activation(T2,"red", TransitionOperation.SendOverNetwork,"P_PED_TL"));
        T2Grd.Activations.add(new Activation(T2,"green", TransitionOperation.SendOverNetwork,"P_PTL"));
        ...
        T3Grd.Activations.add(new Activation(T3,"yellow", TransitionOperation.SendOverNetwork,"P_PTL"));
        ...
        T4Grd.Activations.add(new Activation(T4,"green", TransitionOperation.SendOverNetwork,"P_PED_TL"));
        T4Grd.Activations.add(new Activation(T4,"red", TransitionOperation.SendOverNetwork,"P_PTL"));
